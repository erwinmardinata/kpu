	  ...
	  <div class="box box-primary">
        ...
        <div class="row">
					<div class="col-sm-6">
    				  ...
    				  <label for="name">DPID</label>
							<input type="hidden" name="id" value="<?php echo $data->id; ?>" class="form-control" required>
    				  <input type="text" name="dpid" value="<?php echo $data->dpid; ?>" class="form-control" required>
    				</div>
						<div class="form-group">
    				  <label for="name">No. KK</label>
    				  <input type="text" name="kk" value="<?php echo $data->kk; ?>" class="form-control" required>
    				</div>
						<div class="form-group">
    				  ...
    				  <input type="date" name="tanggal_lahir" value="<?php $tgl = explode('|',$data->tanggal_lahir); echo $tgl[2].'-'.$tgl[1].'-'.$tgl[0]; ?>" class="form-control" required>
    				</div>
						<div class="form-group">
    				  <label for="name">Status Perkawinan</label>
							<select name="status_kawin" class="form-control" required>
								<option value="">-</option>
								<option <?php echo $data->status_kawin=="B"?"selected":""; ?> value="B">Belum Kawin</option>
								<option <?php echo $data->status_kawin=="S"?"selected":""; ?> value="S">Kawin</option>
								<option <?php echo $data->status_kawin=="P"?"selected":""; ?> value="P">Pernah Kawin</option>
							</select>
    				</div>
						<div class="form-group">
					...
					<div class="col-sm-6">
    				  ...
    				  <input type="text" name="dukuh" value="<?php echo $data->dukuh; ?>" class="form-control" required>
    				</div>
						<div class="form-group">
    				  ...
    				  <input type="text" name="rw" value="<?php echo $data->rw; ?>" class="form-control" required>
    				</div>
						<div class="form-group">
    				  <label for="name">Disabilitas</label>
							<select name="disabilitas" class="form-control" required>
								<option value="0">-</option>
								<option <?php echo $data->disabilitas=="1"?"selected":""; ?> value="1">Dis. Fisik</option>
								<option <?php echo $data->disabilitas=="2"?"selected":""; ?> value="2">Dis. Intelektual</option>
								<option <?php echo $data->disabilitas=="3"?"selected":""; ?> value="3">Dis. Mental</option>
								<option <?php echo $data->disabilitas=="4"?"selected":""; ?> value="4">Dis. Sensorik </option>
							</select>
    				</div>
						<div class="form-group">
    				  <label for="name">Status Perekaman KTP-el</label>
							<select name="status_rekam" class="form-control" required>
								<option value="">-</option>
								<option <?php echo $data->status_rekam=="B"?"selected":""; ?> value="B">B - Belum Rekam</option>
								<option <?php echo $data->status_rekam=="S"?"selected":""; ?> value="S">S - Sudah Rekam (Suket)</option>
								<option <?php echo $data->status_rekam=="K"?"selected":""; ?> value="K">K - Sudah Rekam (KTP-el)</option>
							</select>
    				</div>
						<div class="form-group">
    				  <label for="name">Keterangan</label>
							<select name="keterangan" class="form-control" required>
								...
								?>
								<option <?php echo $data->keterangan==$row->kode?"selected":""; ?> value="<?php echo $row->kode; ?>"><?php echo $row->nama; ?></option>
								<?php
									}
								?>
							</select>
						...
						<div class="form-group">
    				  <label for="name">Sumber Data</label>
    				  <input type="text" name="sumber_data" value="<?php echo $data->sumber_data; ?>" class="form-control" required>
    				</div>
						<div class="form-group">
    				  <label for="name">TPS</label>
							<select name="tps" class="form-control" required>
								<option value="">-</option>
								<?php
									foreach($tps as $row) {
								?>
								<option <?php echo $data->tps==$row->id?"selected":""; ?> value="<?php echo $row->id; ?>"><?php echo $row->nama; ?></option>
								<?php
									}
								?>
							</select>
