	  ...
	  <div class="box box-primary">
        ...
        <div class="row">
  			  <div class="col-sm-6">
    				  ...
    				  <input type="text" name="dpid" class="form-control" required>
    				</div>
						<div class="form-group">
					...
					<div class="col-sm-6">
    				  ...
    				  <input type="text" name="dukuh" class="form-control" required>
    				</div>
						<div class="form-group">
    				  ...
    				  <label for="name">Disabilitas</label>
							<select name="disabilitas" class="form-control" required>
								...
								<option value="1">Dis. Fisik</option>
								<option value="2">Dis. Intelektual</option>
								<option value="3">Dis. Mental</option>
								<option value="4">Dis. Sensorik </option>
							</select>
    				</div>
						<div class="form-group">
    				  <label for="name">Status Perekaman KTP-el</label>
							<select name="status_rekam" class="form-control" required>
								<option value="">-</option>
								<option value="B">Belum Rekam</option>
								<option value="S">Sudah Rekam (Suket)</option>
								<option value="K">Sudah Rekam (KTP-el)</option>
							</select>
    				</div>
						<div class="form-group">
