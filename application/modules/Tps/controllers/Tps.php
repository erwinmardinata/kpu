...
class Tps extends Back_controller {
	public $judul = "Data Tps";
	public $url = "Tps";

	function __construct() {

		parent::__construct();
		$this->load->model('Mtps', 'mdl');
	...
	function insert() {
		...
		$query == true ? $this->alert_info('Berhasil Tambah Data Tps') : $this->alert_error('Gagal Tambah Data Tps');
	...
	function update() {
		...
		$query == true ? $this->alert_info('Berhasil Ubah Data Tps') : $this->alert_error('Gagal Ubah Data Tps');
