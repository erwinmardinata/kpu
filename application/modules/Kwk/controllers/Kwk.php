...
class Kwk extends Back_controller {
	public $judul = "Data AB-KWK";
	public $url = "Kwk";

	function __construct() {

		parent::__construct();
		$this->load->model('Mkwk', 'mdl');
	...
	function import_data() {
		...
		$insert = $this->db->insert_batch("ab_kwk",$data);
	...
	function insert() {
		...
		$query == true ? $this->alert_info('Berhasil Tambah Data Kwk') : $this->alert_error('Gagal Tambah Data Kwk');
	...
	function update() {
		...
		$query == true ? $this->alert_info('Berhasil Ubah Data Kwk') : $this->alert_error('Gagal Ubah Data Kwk');
