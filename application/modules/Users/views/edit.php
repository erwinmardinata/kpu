  ...
  <div class="row">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="">
              <div class="row">
                <form class="form" action="<?php echo site_url('Users/update'); ?>" method="post" id="registrationForm" enctype="multipart/form-data">
                              ...
                              <!-- <form class="form" action="##" method="post" id="registrationForm"> -->
                                ...
                                <div class="form-group">
                                    <div class="col-md-6" style="margin-bottom: 15px;">
                                        ...
                                        <input type="email" class="form-control" name="email" value="<?php echo $data->email; ?>" required id="first_name" placeholder="Contoh; 1301013003" title="enter your first name if any.">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6" style="margin-bottom: 15px;">
                                        <label for="first_name">Password</label>
                                        <input type="password" class="form-control" name="password" id="first_name" placeholder="Password" title="enter your first name if any.">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6" style="margin-bottom: 15px;">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6" style="margin-bottom: 15px;">
                                        ...
                                        <input type="text" class="form-control" name="tempat_lahir" value="<?php echo $data->tempat_lahir; ?>"  id="first_name" placeholder="Tempat Lahir" title="enter your first name if any.">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6" style="margin-bottom: 15px;">
                                        <label for="first_name">Tanggal Lahir</label>
                                        <input type="date" class="form-control" name="tanggal_lahir" value="<?php echo $data->tanggal_lahir; ?>" id="first_name" placeholder="Tanggal Lahir" title="enter your first name if any.">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6" style="margin-bottom: 15px;">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6" style="margin-bottom: 15px;">
                                        ...
                                        <input type="text" class="form-control" name="telp" value="<?php echo $data->telp; ?>" id="first_name" placeholder="Telepon" title="enter your first name if any.">
                                    </div>
                                </div>
                                <div class="form-group">
