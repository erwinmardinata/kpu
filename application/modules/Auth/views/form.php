  ...
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <div class="text-center" style="padding: 32px;">
        <img src="<?php echo base_url(); ?>assets/image/logo/logo-kpu.png" class="img-fluid" alt="logo-sumbawa" style="max-width: 40%" />
      </div>
    </div>
    <?php
      ...
      <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
        <div class="row" style="margin-top: 37px;">
          ...
          <form method="post" action="">
            <input type="email" name="email" id="login" class="fadeIn second" name="email" placeholder="Email" required>
            <input type="password" name="password" id="password" class="fadeIn third" name="password" placeholder="password" required>
            <input type="submit" name="submit" class="fadeIn fourth" value="Log In">
          </form>

        </div>
        <!-- <div style="margin-top: -37px;margin-bottom: 15px;">
