	...
	<div class="col-md-12">
	  ...
	  <div class="box box-primary">
        ...
        <div class="row">
            ...
            <div class="form-group">
	  				  <label for="name">Berat</label> <small>dalam KG</small>
	  				  <input type="number" name="berat" id="berat" class="form-control" required>
	  				</div>
            <div class="form-group">
    				  <label for="name">Kadar Air</label>
              <input type="number" step="0.01" name="kadar_air" id="kadar_air" class="form-control" required>
                ...
                <option value="15">26.1% - 27.0%</option>
						...
						<div class="form-group">
	  				  <label for="name">Berat II</label> <small>dalam KG</small>
