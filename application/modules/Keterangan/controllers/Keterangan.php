...
class Keterangan extends Back_controller {
	public $judul = "Data Keterangan TMS";
	public $url = "Keterangan";

	function __construct() {

		parent::__construct();
		$this->load->model('Mketerangan', 'mdl');
	...
	function insert() {
		...
		$query == true ? $this->alert_info('Berhasil Tambah Data Keterangan') : $this->alert_error('Gagal Tambah Data Keterangan');
	...
	function update() {
		...
		$query == true ? $this->alert_info('Berhasil Ubah Data Keterangan') : $this->alert_error('Gagal Ubah Data Keterangan');
