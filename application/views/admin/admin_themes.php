...
<head>
	...
	<link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url(); ?>assets/image/logo/logo-kpu.png">
 ...
 <!-- Javascripts-->
	...
	<script src="<?php echo base_url(); ?>assets/kcfinder/ckfinder.js"></script>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo site_url('Dashboard'); ?>" class="logo">
      ...
      <span class="logo-mini"><b>K</b>PU</span>
        ...
        <li class="header">MASTER MENU</li>
          ...
          <a href="<?php echo site_url('Dashboard'); ?>">
            <i class="fa fa-dashboard"></i> <span>Beranda</span>
				...
				<li class="treeview
				<?php
					if($subtitle == 'Tps' || $subtitle == 'Keterangan') {
						echo "active";
					}
				?>
				">
          ...
          <ul class="treeview-menu">
						<li class="<?php echo $subtitle=='Tps'?'active':''; ?>"><a href="<?php echo site_url('Tps'); ?>"><i class="fa fa-circle-o"></i> TPS</a></li>
            <li class="<?php echo $subtitle=='Keterangan'?'active':''; ?>"><a href="<?php echo site_url('Keterangan'); ?>"><i class="fa fa-circle-o"></i> Keterangan</a></li>
          </ul>
        </li>
				<li class="<?php echo $subtitle=='Kwk'?'active':''; ?>">
          <a href="<?php echo site_url('Kwk'); ?>">
            <i class="fa fa-user"></i> <span>Data AB-KWK</span>
          </a>
        </li>
				<li class="<?php echo $subtitle=='Tms'?'active':''; ?>">
          <a href="<?php echo site_url('Tms'); ?>">
            <i class="fa fa-database"></i> <span>Rekap Bantu</span>
          </a>
        </li>
